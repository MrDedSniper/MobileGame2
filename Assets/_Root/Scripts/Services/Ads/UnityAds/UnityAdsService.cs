 ...
 namespace Services.Ads.UnityAds
{
    internal class UnityAdsService : MonoBehaviour, IUnityAdsInitializationListener, IAdsService
    {
        ...
        private void InitializeAds() => Advertisement.Initialize(gameId, true, this);
            //Advertisement.Initialize(_settings.GameId, _settings.TestMode, _settings.EnablePerPlacementMode, this);
        ...
        private IAdsPlayer CreateRewarded() =>
            _settings.Rewarded.Enabled ? new RewardedAdsPlayer(_settings.Rewarded.Id) : new StubPlayer("");
